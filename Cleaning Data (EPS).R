...
load("D:/Master Denmark/3rd semester/Political Data Science/Final Exam/True Final Exam/1. Downloading/ElPaisSanchezText.RData")
...
save(fulltexttext, file = "Sanchez(ElPais).RData")  #just in case
save(textclean, file = "Sanchez(ElPais)clean.RData")
