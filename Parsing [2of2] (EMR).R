...
# create main archive
if(!dir.exists("ElMundoRajoy")) dir.create("ElMundoRajoy")

# create sub-archive for search results
archive.folder <- "./ElMundoRajoy/fulltext/"
if(!dir.exists(archive.folder)) dir.create(archive.folder)

load("D:/Master Denmark/3rd Semester/Political Data Science/Final Exam/True Final Exam/1. Downloading/ElMundoRajoyFinal.RData")
...
save(finaldata, file = "ElMundoRajoyText.RData")
