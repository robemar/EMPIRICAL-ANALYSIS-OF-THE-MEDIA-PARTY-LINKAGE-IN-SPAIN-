...
load("D:/Master Denmark/3rd semester/Political Data Science/Final Exam/True Final Exam/1. Downloading/ElMundoRajoyText.RData")
...
save(fulltexttext, file = "Rajoy(ElMundo).RData") #just in case
save(textclean, file = "Rajoy(ElMundo)clean.RData")
