...
load("D:/Master Denmark/3rd semester/Political Data Science/Final Exam/True Final Exam/1. Downloading/ElPaisRajoyText.RData")
...
save(fulltexttext, file = "Rajoy(ElPais).RData")  #just in case
save(textclean, file = "Rajoy(ElPais)clean.RData")
