...
load("D:/Master Denmark/3rd Semester/Political Data Science/Final Exam/True Final Exam/1. Downloading/RajoyElPaistopics.RData")
...
save(text.df, file="itsworking(EPR).RData")
...
qplot(data = newdata, x = score, 
      geom = "bar", xlab = "", 
      ylab = "Frequency", main = "Rajoy's Executive teatment ElPais") + 
  theme_bw() +
...
save(dataEPR, file="Complete(EPR).RData")
