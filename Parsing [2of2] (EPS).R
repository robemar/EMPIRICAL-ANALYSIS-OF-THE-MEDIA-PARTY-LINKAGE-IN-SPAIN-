...
load("D:/Master Denmark/3rd Semester/Political Data Science/Final Exam/True Final Exam/1. Downloading/ElPaisSanchezFinal.RData")
...
save(finaldata, file = "ElPaisSanchezText.RData")
